...
export class CasasController {
  ...
  // GET /casas/buscar?q=algo&page=1
  @Public()
  @Get('buscar')
  ...
  // POST /casas/sincronizar-pinecone  👈 endpoint de sincronización manual
  // @Public()
  @Post('sincronizar-pinecone')
  sincronizarPinecone() {
    return this.casasService.sincronizarPinecone();
  }

  // GET /casas/host/:hostId
  @Get('host/:hostId')
  obtenerCasasPorHost(@Param('hostId') hostId: string) {
    return this.casasService.obtenerCasasPorHost(Number(hostId));
  }

  // GET /casas/:id
  @Public()
  @Get(':id')
  obtenerCasaPorId(@Param('id') id: string) {
    return this.casasService.obtenerCasaPorId(Number(id));
  }

  // POST /casas
  @Post()
  crearCasa(@Body() body: NuevaCasa) {
    return this.casasService.crearCasa(body);
  }

  // PUT /casas/:id
  @Put(':id')
  actualizarCasa(@Param('id') id: string, @Body() data: UpdateCasa) {
